...
void loop() {
  ...
  if (client) {
...

    {
      ...
      if (https.begin(*client, "https://www.postb.in/1724831336735-1994523359462?hello=sami")) {  // HTTPS for postbin use this link: https://www.postb.in/b/1724831336735-1994523359462. for jigsaw use this link: https://jigsaw.w3.org/HTTP/connection.html
